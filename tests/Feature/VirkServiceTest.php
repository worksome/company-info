...
it('can lookup a company name on dk virk with faked response', function (string $name, string $number, array $expected, array $response) {
...
it('can lookup a company number on dk virk with faked response', function (string $name, string $number, array $expected, array $response) {
