...
it(
    'looks up company info on name for gb country using artisan command',
...
it(
    'looks up company info on name for gb country using artisan command, output as json',
    function (string $name, string $number, array $expected) {
        $this
            ->artisan('company-info:lookup', [
                '--name'    => $name,
...
it(
    'looks up company info on number for gb country using artisan command',
    function (string $name, string $number, array $expected) {
        $this
            ->artisan('company-info:lookup', [
                '--number'  => $number,
