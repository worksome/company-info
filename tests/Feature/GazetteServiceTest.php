...
it('can lookup a company name on the gb gazette with faked response', function (string $name, string $number, array $expected, array $response) {
...
it('can lookup a company number on the gb gazette with faked response', function (string $name, string $number, array $expected, array $response) {
