...
it(
    'can lookup a company name on dk cvr api with faked service',
...
it(
    'can lookup a company name on dk cvr api with faked response',
    function (string $name, string $number, array $expected, array $response) {
...
it(
    'can lookup a company name on dk cvr api with actual service',
...
it(
    'can lookup a company number on dk cvr api with faked service',
    function (string $name, string $number, array $expected, array $response) {
        Http::fake(['*' => Http::response($response['cvrapi'])]);
...
it(
    'can lookup a company number on dk cvr api with faked response',
    function (string $name, string $number, array $expected, array $response) {
...
it(
    'can lookup a company number on dk cvr api with actual service',
    function (string $name, string $number, array $expected) {
        $service = $this->app->get(CompanyInfoManager::class)->driver('cvrapi');
...
it(
    'can lookup a company name on no cvr api with faked service',
    function (string $name, string $number, array $expected, array $response) {
        Http::fake(['*' => Http::response($response['cvrapi'])]);
...
it(
    'can lookup a company name on no cvr api with faked response',
    function (string $name, string $number, array $expected, array $response) {
...
it(
    'can lookup a company name on no cvr api with actual service',
    function (string $name, string $number, array $expected) {
        $service = $this->app->get(CompanyInfoManager::class)->driver('cvrapi');
...
it(
    'can lookup a company number on no cvr api with faked service',
    function (string $name, string $number, array $expected, array $response) {
        Http::fake(['*' => Http::response($response['cvrapi'])]);
...
it(
    'can lookup a company number on no cvr api with faked response',
    function (string $name, string $number, array $expected, array $response) {
...
it(
    'can lookup a company number on no cvr api with actual service',
    function (string $name, string $number, array $expected) {
        $service = $this->app->get(CompanyInfoManager::class)->driver('cvrapi');
